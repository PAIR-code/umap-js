...
var utils = __webpack_require__(1);
var ml_levenberg_marquardt_1 = __webpack_require__(8);
...
function makeInitializations(distanceFn) {
    function initFromRandom(nNeighbors, data, queryPoints, _heap) {
    ...
    function initFromTree(_tree, data, queryPoints, _heap) {
        for (var i = 0; i < queryPoints.length; i++) {
...
function step(
  ...
  var identity = matrix_Matrix.eye(params.length, params.length, value);
